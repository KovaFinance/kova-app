 ...
 * lib/env.ts). RELAYER_JWT = gasless relayer (Channels) spending credential;
 * DATABASE_URL = Postgres for the wallet-mapping store.
 */
export const REQUIRED_SERVER_ENV = ["RELAYER_JWT", "DATABASE_URL"];
